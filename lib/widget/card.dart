...
class _SlimyCardState extends State<SlimyCard> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    bottomDimension = initialBottomDimension;
    topCardWidget = (widget.topCardWidget != null) ? widget.topCardWidget : simpleTextWidget('This is Top Card Widget.');
    bottomCardWidget = (widget.bottomCardWidget != null) ? widget.bottomCardWidget : simpleTextWidget('This is Bottom Card Widget.');
  ...
  void didChangeDependencies() {
    ...
    gapInitial = ((widget.topCardHeight - x! - widget.width / 4) > 0) ? (widget.topCardHeight - x! - widget.width / 4) : 0;
    gapFinal = ((widget.topCardHeight + x! - widget.width / 4 + 50) > 0) ? (widget.topCardHeight + x! - widget.width / 4 + 50) : 2 * x! + 50;
    gap = gapInitial;
  }
