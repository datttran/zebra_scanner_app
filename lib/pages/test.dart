...
class _TestState extends State<Test> {
  ...
  Widget build(BuildContext context) {
    List<Widget> homeItems = [
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text('- - Today Orders: ' + todayOrder!.length.toString(), style: TextStyle(color: Color(0xffffffff), fontSize: 14))
              ],
            ),
          ],
        ),
      ...
      Row(
        children: [_isLoading ? Container(height: 300, width: hP * 100, child: Center(child: CircularProgressIndicator())) : getOderList()],
      ),
      Container(
        height: vP * 20,
        width: hP * 90,
  ...
  getTodayTender() async {
    ...
    customCardTapped = List.filled(todayOrder!.length, false);
  }
  ...
  getOderList() {
    return Expanded(
      ...
      height: customCardTapped.contains(true) ? 350 : 250,
