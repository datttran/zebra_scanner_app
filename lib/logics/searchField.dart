...
class SearchField extends StatefulWidget {
  ...
  })  : assert((initialValue != null && suggestions.contains(initialValue)) || initialValue == null, 'Initial value should either be null or should be present in suggestions list.'),
        super(key: key);
          ...
          return AnimatedContainer(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => GestureDetector(
                ...
                child: Container(
                  height: widget.itemHeight,
                  padding: EdgeInsets.symmetric(horizontal: 5) + EdgeInsets.only(left: 8),
        ...
        CompositedTransformTarget(
          ...
          child: TextFormField(
            onTap: () {
              ...
              if (!sourceFocused && widget.suggestionState == SuggestionState.onTap) {
                setState(() {
                  sourceFocused = true;
                });
                Future.delayed(Duration(milliseconds: 100), () {
            ...
            decoration: widget.searchInputDecoration?.copyWith(hintText: widget.hint) ?? InputDecoration.collapsed(hintText: widget.hint),
            onChanged: (item) {
